...
import useUpdateReptileEventMutation from "../Agenda/hooks/mutations/useUpdateReptileEventMutation";
...
const EditEvent = () => {
  ...
  useEffect(() => {
    setInputDate(parseDateForPicker(event?.event_date));
    setInputRecurrenceUntil(parseDateForPicker(event?.recurrence_until || ""));
  }, [event?.event_date, event?.recurrence_until]);
    ...
    <Screen>
      ...
      <Formik
        ...
        initialValues={{
          ...
          event_date: event.event_date ?? formatYYYYMMDD(new Date()),
